...
public class Hobbit extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 4572311280218064478L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Hobbit\",\"namespace\":\"com.interfrontier.kafkarestms.avro\",\"fields\":[{\"name\":\"quote\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"id\",\"type\":\"int\"}]}");
   ...
   */
  public Hobbit(java.lang.CharSequence quote, java.lang.Integer id) {
    this.quote = quote;
    this.id = id;
  }
   ...
   */
  public static com.interfrontier.kafkarestms.avro.Hobbit.Builder newBuilder() {
    return new com.interfrontier.kafkarestms.avro.Hobbit.Builder();
  }
   ...
   * @return A new Hobbit RecordBuilder
   */
  public static com.interfrontier.kafkarestms.avro.Hobbit.Builder newBuilder(com.interfrontier.kafkarestms.avro.Hobbit.Builder other) {
    if (other == null) {
      return new com.interfrontier.kafkarestms.avro.Hobbit.Builder();
    } else {
      return new com.interfrontier.kafkarestms.avro.Hobbit.Builder(other);
    }
  }
   ...
   * @return A new Hobbit RecordBuilder
   */
  public static com.interfrontier.kafkarestms.avro.Hobbit.Builder newBuilder(com.interfrontier.kafkarestms.avro.Hobbit other) {
    if (other == null) {
      return new com.interfrontier.kafkarestms.avro.Hobbit.Builder();
    } else {
      return new com.interfrontier.kafkarestms.avro.Hobbit.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Hobbit>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.interfrontier.kafkarestms.avro.Hobbit.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.interfrontier.kafkarestms.avro.Hobbit other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.quote)) {
        this.quote = data().deepCopy(fields()[0].schema(), other.quote);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.interfrontier.kafkarestms.avro.Hobbit.Builder setQuote(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.interfrontier.kafkarestms.avro.Hobbit.Builder clearQuote() {
      quote = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.interfrontier.kafkarestms.avro.Hobbit.Builder setId(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.interfrontier.kafkarestms.avro.Hobbit.Builder clearId() {
